...
public class Ejercicio4 { 
	...
	respuesta = new int [100][100];//dimencion de la primera matriz
	valores_x = new int [100][100];//dimencion de la segunda matriz
	int contador = 0;
	int contador_aux = 0;
	while (bandera == true) {
	    ...
	    respuesta [0][contador] = 3*x + 6 ;//almacenar las respuestas  
	    contador = contador + 1;
